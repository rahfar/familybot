...
export TG_GROUPID=$(bws secret get 0a25642b-b877-4415-962b-b041013fb276 | jq -r .value)
export TG_ADMINUSERIDS=$(bws secret get dd565e5f-a287-4f5e-99f9-b35b015163c6 | jq -r .value)
